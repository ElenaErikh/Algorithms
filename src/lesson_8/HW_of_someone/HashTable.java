package lesson_8.HW_of_someone;
...
public class HashTable {
    ...
    public HashTable(int size) {   // он сделал два конструктора, без параметра исп-ся линейное пробирование,
        // с параметром включается двойное хеширование
        this.arrSize = size;
    ...
    public HashTable(int size, boolean useDoubleHashing) {     // с параметром включается двойное хеширование
        this.arrSize = size;
        this.hashArr = new Flat[arrSize];
        this.nonFlat = new Flat(-1, "");
